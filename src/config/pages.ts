...
export const staticPages: StaticPage[] = [
  ...
  },
  {
    ...
    tags: ["о компании", "о нас", "RCONS", "about", "关于我们", "бизарыс туралы"],
    priority: 0.8,
  },
  {
    href: "/contacts",
  ...
  },
  {
    ...
    tags: ["документы", "нормативные документы", "скачать", "documents", "文件"],
    priority: 0.6,
  },
  {
    href: "/resources/sro",
    ...
    tags: ["СРО", "саморегулируемая организация", "членство", "SRO", "self-regulatory", "行业协会"],
    priority: 0.6,
  },
  {
  ...
  },
  {
    ...
    tags: ["квалификации", "сертификаты", "аттестаты", "аудиторы", "qualifications", "资质认证"],
    priority: 0.6,
  },
];
