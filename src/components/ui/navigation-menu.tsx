...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <ChevronDownIcon
        className="relative top-px ml-1 size-3 transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group:hover:rotate-180 group-data-open/navigation-menu-trigger:rotate-180"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  );
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        // base
        "absolute top-full left-0 z-50 mt-1.5",
        // shape
        "overflow-hidden  border border-stroke",
        "bg-bg-l shadow-[0_8px_32px_rgba(0,0,0,0.08)]",
        // open
